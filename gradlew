...
#   * The complex value construction is to ensure that variable expansion and command
#     substitution happen in the correct order.
...
# Stop when "xeli" was found in JAVA_OPTS or GRADLE_OPTS
